...
exports.getFoundationTools = getFoundationTools;
const response_js_1 = require("../contracts/response.js");
/**
 ...
 */
function getFoundationTools(manifest, domainTools) {
    return [
        // ---- health_check ----
        {
            name: 'health_check',
            ...
            inputSchema: {},
            handler: async () => (0, response_js_1.buildEnvelope)({
        ...
        // ---- list_server_tools ----
        {
            ...
            handler: async () => {
                ...
                return (0, response_js_1.buildEnvelope)({
